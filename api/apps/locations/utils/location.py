...
from apps.locations.models.area import Area
...
class AddressFormatter:
    ...
    def O(self):  # noqa E743
        ...
        """
        return (
            self.address["openbare_ruimte"]
            if self.address and "openbare_ruimte" in self.address
            else ""
        )
    ...
    def h(self):
        ...
        """
        return (
            self.address["huisnummer"]
            if self.address and "huisnummer" in self.address
            else ""
        )
    ...
    def l(self):  # noqa E743
        ...
        """
        return (
            self.address["huisletter"]
            if self.address and "huisletter" in self.address
            else ""
        )
    ...
    def t(self):
        ...
        """
        return (
            self.address["huisnummer_toevoeging"]
    ...
    def T(self):  # noqa E743
        ...
        if (
            self.address
            and "huisnummer_toevoeging" in self.address
    ...
    def p(self):
        ...
        return (
            ...
            if self.address and "postcode" in self.address
            else ""
        )
    ...
    def P(self):  # noqa E743
        ...
        return (
            str(re.sub("(^[0-9]+)", r" \1 ", self.address["postcode"])).strip()
            if self.address and "postcode" in self.address
            else ""
        )
    ...
    def W(self):  # noqa E743
        ...
        """
        return (
            self.address["woonplaats"]
            if self.address and "woonplaats" in self.address
            else ""
        )
